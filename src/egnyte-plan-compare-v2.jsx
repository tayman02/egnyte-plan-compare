      ...
      <div style={{ minHeight:"100vh", background:`linear-gradient(150deg,#0C2340 0%,#121F37 100%)`, color:E.text }}>
        ...
        <header style={{ position:"relative", overflow:"hidden", background:E.navyMid, borderBottom:`1px solid ${E.border}`, boxShadow:"0 4px 24px rgba(0,0,0,0.4)" }}>
          ...
          <div style={{ position:"relative", zIndex:1, maxWidth:1680, margin:"0 auto", padding:"0 32px", display:"flex", alignItems:"center", justifyContent:"space-between", height:64 }}>
            ...
            {/* Left — Egnyte logo + Compass brand */}
            <div style={{ display:"flex", alignItems:"center", gap:0 }}>
              {/* Egnyte PARTNER PROGRAM wordmark */}
              <svg width="666" height="101" style={{height:34,width:"auto"}} viewBox="0 0 666 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M426.639 16.7934V94.8084" stroke="#0BC5BA" strokeWidth="4.6499" strokeLinecap="round"/>
              ...
              {/* Teal divider */}
              <div style={{ width:1, height:30, background:"rgba(11,197,186,0.3)", margin:"0 20px" }}/>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
                  <span style={{ fontSize:16, fontWeight:800, color:"white", letterSpacing:"0.1em", textTransform:"uppercase", lineHeight:1.1, fontFamily:"'Inter',sans-serif" }}>Compass</span>
                  <span style={{ fontSize:8.5, fontWeight:600, color:"rgba(11,197,186,0.7)", letterSpacing:"0.15em", textTransform:"uppercase", lineHeight:1, fontFamily:"'Inter',sans-serif" }}>MSP Partner Tool</span>
                </div>
              </div>
            </div>
