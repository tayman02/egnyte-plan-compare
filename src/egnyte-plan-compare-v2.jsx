...
const TOUR_SLIDES = [
  ...
  },
  {
    ...
    sub: "Start here when a customer wants to explore a higher-tier plan",
    body: "Select the customer's current and proposed plan to instantly see net-new features, price uplift, and deal revenue impact. Works for any upgrade path — Legacy, Gen 3, or lower-tier Gen 4 plans moving up. Enter user count to calculate monthly and annual numbers, then generate an AI Value Summary tailored to any vertical or customer context.",
    accent: "#0BC5BA",
    badgeColor: "#0BC5BA",
    badgeBg: "rgba(11,197,186,0.12)",
  },
